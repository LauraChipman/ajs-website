...
export default function AdminAboutPage() {
    ...
    const handleUpdate = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.put(`http://localhost:5000/api/about/${about._id}`, {
                content: formData,
            });
    ...
    const handleDelete = async () => {
        try {
            ...
            await axios.delete(`http://localhost:5000/api/about/${about._id}`);
            setAbout(null);
            setFormData('');
    ...
    const handleUndoDelete = async () => {
        ...
        try {
            const res = await axios.post('http://localhost:5000/api/about', {
