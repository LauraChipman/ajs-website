...
export default function AdminDrinksPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editingId) {
                ...
                await axios.put(`http://localhost:5000/api/drinks/${editingId}`, {
                    name: formData.name,
                ...
                await axios.post('http://localhost:5000/api/drinks/upload', form, {
    ...
    const handleDelete = async (id) => {
        await axios.delete(`http://localhost:5000/api/drinks/${id}`);
        fetchDrinks();
    };
